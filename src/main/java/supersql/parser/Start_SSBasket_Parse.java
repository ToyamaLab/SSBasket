...
public class Start_SSBasket_Parse {
	...
	public Start_SSBasket_Parse() {
		parseSSQL(this.getSSQLQuery(), 10000);
	}

	public Start_SSBasket_Parse(int id) {
		parseSSQL(this.getSSQLQuery(), id);
	}

	public Start_SSBasket_Parse(String a) {
		parseSSQL(this.getSSQLQuery2(), 10000);
	}

	public Start_SSBasket_Parse(StringBuffer querybuffer) {
	...
	public static void setDbpediaQuery(boolean dbpediaQuery) {
		Start_SSBasket_Parse.dbpediaQuery = dbpediaQuery;
	}
	public static void setJsonQuery(boolean jsonQuery) {
		Start_SSBasket_Parse.jsonQuery = jsonQuery;
	}

	public static void setSparqlQuery(boolean sparqlQuery) {  //add ayumi
		Start_SSBasket_Parse.sparqlQuery = sparqlQuery;
	}
