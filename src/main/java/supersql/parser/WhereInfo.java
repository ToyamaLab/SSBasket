...
public class WhereInfo implements Serializable {
	...
	public WhereInfo() {
		if(Start_Parse.isDbpediaQuery() || Start_Parse.isSparqlQuery() || Start_Parse.isJsonQuery())
			//setDBPediaWhereQUery("");
			setSparqlWhereQuery("");
		else{
	...
	public String getDBPediaWhereQuery() {
		return sparqlWhereQuery;
	}

	public void setDBPediaWhereQuery(String dbpediaWhereQuery) {
		this.sparqlWhereQuery = dbpediaWhereQuery;
	}
