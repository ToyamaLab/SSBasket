...
public class GlobalEnv {
	...
	public static boolean csvFlag = false; //ayumi
	...
	//ayumi add
	public static HashMap<String, String> csvTable = new HashMap<String, String>();
	public static int outputcsvNum = 0;
	public static int recursiveSearchFlag = 0;
	public static int recursiveNum = 0;
	public static int recursiveSPARQLNum = 0;
	public static ArrayList<String> recursiveSearchTable = new ArrayList<String>();
	public static String defaultdriver;
	public static String defaultdb;
	private static String sparqlendpoint = "http://ja.dbpedia.org/sparql";
	private static String sparqlprefix =
    ...
    private static String sqlitedir;
    private static String sqlitedb = "test.db";
...
//		//added by goto 20120707 end
	...
	public static void getConfig() {
		...
		if (config == null) {
			...
			if(new File(home.concat("/.ssb")).exists()) //.ssql changes .ssb by ayumi
			config = home.concat("/.ssb");
			else
			config = home.concat("/config.ssb");
		...
		try {
			...
			if(c_value[18] != null){
				addprefix(c_value[18]);
			}
			if(c_value[19] != null) {
				sparqlendpoint = c_value[19];
			}
			if(c_value[20] != null) {
		...
		", sparql_prefix=" + getprefix()+ ", sparql_endpoint=" + getendpoint()+
		", sqlite_dir=" + sqlitedir + ", sqlite_db=" + sqlitedb + "}");
		return;
	}
	...
	*/
	...
	public static void setdriver(String input) { //add ayumi
		driver=input;
	}

	public static void setdb(String input) {
		db=input;
	}
	...
	*/
	public static String getfilename() {	// /user/xx/test.ssql
		...
		if(filename == null){// for embed ssql
			...
			if(filename.indexOf(".ssbr") > 0 || filename.indexOf(".ssb") > 0 || filename.indexOf(".ssql") > 0 || filename.indexOf(".sql") > 0){
				return filename;
			}else{
				System.err.println("file extension is must be '.ssb' or '.ssql' or '.sql'");
				System.exit(1);
			}
			return seek("-f");
		}
	...
	public static String getcsvfilename() {	// /user/xx/test.ssql //add ayumi
	String filename = seek("-csv");
	if(filename == null){
			return null;
	}else{
	...
	//			return filename;
	//		}else{
	//			System.err.println("file extension is must be '.csv'");
	//			System.exit(1);
	//		}
			return seek("-csv");
	}
	...
	public static String getcsvtablename() {	// /user/xx/test.ssql //add ayumi
		String tablename = seek("-csvt");
		if(tablename == null){
			return null;
		}else{
			return tablename;
	...
	public static String getcsvcolumntype() {
		String tabletype = seek("-csvct");
		if(tabletype == null){
			return null;
		}else{
			return seek("-csvct");
...
//					}
	...
	*/
	...
	protected static String[] getConfigValue(String config) {
		...
		"unity_module_dir", "port", "sqlserver_instance", "sqlserver_options", "sparql_prefix", "sparql_endpoint", "sqlite_dir", "sqlite_db"};//module180426
	...
	*/
	...
	public static String getCsvDirectory(){ //add ayumi
		return seek("-csvdirectory");
	}
...
//	}
	...
	public static void plusOutputCSVNumCount() {
		GlobalEnv.outputcsvNum ++;
	}

	public static int getOutputCSVNum() {
		return outputcsvNum;
	}

	public static void setRecursiveSearchFlag(int n) {
		GlobalEnv.recursiveSearchFlag = n;
	}

	public static void plusRecursiveSearchFlag() {
		GlobalEnv.recursiveSearchFlag ++;
	}

	public static int isRecursiveSearchFlag() {
		return recursiveSearchFlag;
	}

	public static void setRecursiveNum(int n) {
		GlobalEnv.recursiveNum = n;
	}

	public static int plusRecursiveNum() {
		return recursiveNum++;
	}

	public static int getRecursiveNum() {
		return recursiveNum;
	}

	public static void setRecursiveSPARQLNum(int n) {
		GlobalEnv.recursiveSPARQLNum = n;
	}

	public static int plusRecursiveSPARQLNum() {
		return recursiveSPARQLNum++;
	}

	public static int getRecursiveSPARQLNum() {
		return recursiveSPARQLNum;
	}
	...
	public static String getSQLitedb() {
		return sqlitedir+sqlitedb;
	}

	public static String getDefaultdburl() {
		String url = "jdbc:postgresql://" + host + ":" + port + "/" + defaultdb;
		return url;
	}
