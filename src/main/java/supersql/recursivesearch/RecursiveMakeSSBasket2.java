...
public class RecursiveMakeSSBasket2 {
	...
	public static void writeTarget(ExtList now) {
		...
		//	ssqlgenerate+="a("+now.get(1)+"."+now.get(1)+","+now.get(2)+"."+now.get(2)+")";
			ssqlgenerate+="a("+now.get(1)+".title,"+now.get(2)+".url)";
		//	ssqlfrom+=", \"#"+now.get(1)+".csv\" "+now.get(1);
		//	ssqlfrom+=", \"#"+now.get(2)+".csv\" "+now.get(2);
		}else {
		//	ssqlgenerate += "'"+now.get(1)+"'";
			ssqlgenerate+=now.get(1)+".title";
		//	ssqlfrom+=", \"#"+now.get(1)+".csv\" "+now.get(1);
		}
		ssqlfrom+=", \"#"+now.get(1)+".csv\" "+now.get(1);
		if(yet.matches("^@\\{.*\\}.*")) {
